...
public class RobotMap {
  public static final int DRIVETRAIN_FRONT_LEFT_ANGLE_MOTOR = 7; // CAN
  ...
  public static final int DRIVETRAIN_FRONT_RIGHT_DRIVE_MOTOR = 6; // CAN

  public static final int DRIVETRAIN_BACK_LEFT_ANGLE_MOTOR = 1; // CAN
  ...
  public static final int DRIVETRAIN_BACK_RIGHT_ANGLE_MOTOR = 3; // CAN
  public static final int DRIVETRAIN_BACK_RIGHT_ANGLE_ENCODER = 1; // Analog
  public static final int DRIVETRAIN_BACK_RIGHT_DRIVE_MOTOR = 4; // CAN
}
